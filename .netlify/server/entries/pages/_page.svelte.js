...
function IntrigueCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="intrigue-card svelte-1miltlz" role="button" tabindex="0"><div class="card-content svelte-1miltlz"><div class="header-text svelte-1miltlz">${escape_html(intrigue.name)}</div> <div class="info-section svelte-1miltlz"><div class="info-row svelte-1miltlz"><span class="info-label svelte-1miltlz">CATEGORY</span> <span${attr_class(`info-value ${stringify(isOutlaw ? "outlaw-text" : "")}`, "svelte-1miltlz")}>${escape_html(intrigue.category)}</span></div> <div class="info-row svelte-1miltlz"><span class="info-label svelte-1miltlz">TEST</span> <span class="info-value svelte-1miltlz">${escape_html(intrigue.alignmentTest)}</span></div> <div class="info-row svelte-1miltlz"><span class="info-label svelte-1miltlz">REWARD</span></div> <div class="reward-text svelte-1miltlz">${escape_html(intrigue.reward)}</div></div> <div class="criteria-section svelte-1miltlz"><div class="criteria-label svelte-1miltlz">CRITERIA</div> <div class="criteria-text svelte-1miltlz">${escape_html(intrigue.criteria)}</div></div></div></div>`);
